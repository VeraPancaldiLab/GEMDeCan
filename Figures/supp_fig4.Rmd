...
fig_Lym_COAD_3DRNA <- ggplot(as.data.frame(Lym_COAD_3DRNA), aes(x = Lymphocytes, y = Cancer_cell_fractions)) +
  ...
  theme(axis.title.x = element_text(vjust = -0.5), strip.text.x = element_text(size = 18, color = "black", face = "bold"), text = element_text(size = 20), aspect.ratio=1) +
...
Lym_COAD_avrg <- cbind(lymph_COAD_BPRNACan3DProMet_avr, HE_COAD_modif$Lymphocytes)
colnames(Lym_COAD_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_COAD_BPRNACan3DProMet_avr - HE_COAD_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_COAD_avrg <- cbind(Macro_COAD_BPRNACan3DProMet_avr, HE_COAD_modif$Macrophages)
colnames(Macro_COAD_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_COAD_BPRNACan3DProMet_avr - HE_COAD_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_COAD_avrg <- cbind(rowMeans(cbind(COAD_BPRNACan3DProMet_decon$Neu, COAD_methy_decon$Neu)), HE_COAD_modif$Neutrophils)
colnames(Neu_COAD_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(COAD_BPRNACan3DProMet_decon$Neu, COAD_methy_decon$Neu) - HE_COAD_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_COAD_3DRNA, fig_Neu_COAD_BPmetCan, fig_Neu_COAD_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_COAD_3DRNA, fig_Macro_COAD_BPmetCan, fig_Macro_COAD_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_COAD <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_COAD
ggsave("ALL_COAD.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
...
Lym_LUAD_avrg <- cbind(lymph_LUAD_BPRNACan3DProMet_avr, HE_LUAD_modif$Lymphocytes)
colnames(Lym_LUAD_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_LUAD_BPRNACan3DProMet_avr - HE_LUAD_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_LUAD_avrg <- cbind(Macro_LUAD_BPRNACan3DProMet_avr, HE_LUAD_modif$Macrophages)
colnames(Macro_LUAD_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_LUAD_BPRNACan3DProMet_avr - HE_LUAD_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_LUAD_avrg <- cbind(rowMeans(cbind(LUAD_BPRNACan3DProMet_decon$Neu, LUAD_methy_decon$Neu)), HE_LUAD_modif$Neutrophils)
colnames(Neu_LUAD_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(LUAD_BPRNACan3DProMet_decon$Neu, LUAD_methy_decon$Neu) - HE_LUAD_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_LUAD_3DRNA, fig_Neu_LUAD_BPmetCan, fig_Neu_LUAD_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_LUAD_3DRNA, fig_Macro_LUAD_BPmetCan, fig_Macro_LUAD_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_LUAD <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_LUAD
ggsave("ALL_LUAD.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_LUSC_avrg <- cbind(lymph_LUSC_BPRNACan3DProMet_avr, HE_LUSC_modif$Lymphocytes)
colnames(Lym_LUSC_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_LUSC_BPRNACan3DProMet_avr - HE_LUSC_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_LUSC_avrg <- cbind(Macro_LUSC_BPRNACan3DProMet_avr, HE_LUSC_modif$Macrophages)
colnames(Macro_LUSC_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_LUSC_BPRNACan3DProMet_avr - HE_LUSC_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_LUSC_avrg <- cbind(rowMeans(cbind(LUSC_BPRNACan3DProMet_decon$Neu, LUSC_methy_decon$Neu)), HE_LUSC_modif$Neutrophils)
colnames(Neu_LUSC_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(LUSC_BPRNACan3DProMet_decon$Neu, LUSC_methy_decon$Neu) - HE_LUSC_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_LUSC_3DRNA, fig_Neu_LUSC_BPmetCan, fig_Neu_LUSC_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_LUSC_3DRNA, fig_Macro_LUSC_BPmetCan, fig_Macro_LUSC_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_LUSC <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_LUSC
ggsave("ALL_LUSC.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_PRAD_avrg <- cbind(lymph_PRAD_BPRNACan3DProMet_avr, HE_PRAD_modif$Lymphocytes)
colnames(Lym_PRAD_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_PRAD_BPRNACan3DProMet_avr - HE_PRAD_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_PRAD_avrg <- cbind(Macro_PRAD_BPRNACan3DProMet_avr, HE_PRAD_modif$Macrophages)
colnames(Macro_PRAD_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_PRAD_BPRNACan3DProMet_avr - HE_PRAD_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_PRAD_avrg <- cbind(rowMeans(cbind(PRAD_BPRNACan3DProMet_decon$Neu, PRAD_methy_decon$Neu)), HE_PRAD_modif$Neutrophils)
colnames(Neu_PRAD_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(PRAD_BPRNACan3DProMet_decon$Neu, PRAD_methy_decon$Neu) - HE_PRAD_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_PRAD_3DRNA, fig_Neu_PRAD_BPmetCan, fig_Neu_PRAD_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_PRAD_3DRNA, fig_Macro_PRAD_BPmetCan, fig_Macro_PRAD_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_PRAD <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_PRAD
ggsave("ALL_PRAD.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_BRCA_avrg <- cbind(lymph_BRCA_BPRNACan3DProMet_avr, HE_BRCA_modif$Lymphocytes)
colnames(Lym_BRCA_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_BRCA_BPRNACan3DProMet_avr - HE_BRCA_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_BRCA_avrg <- cbind(Macro_BRCA_BPRNACan3DProMet_avr, HE_BRCA_modif$Macrophages)
colnames(Macro_BRCA_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_BRCA_BPRNACan3DProMet_avr - HE_BRCA_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_BRCA_avrg <- cbind(rowMeans(cbind(BRCA_BPRNACan3DProMet_decon$Neu, BRCA_methy_decon$Neu)), HE_BRCA_modif$Neutrophils)
colnames(Neu_BRCA_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(BRCA_BPRNACan3DProMet_decon$Neu, BRCA_methy_decon$Neu) - HE_BRCA_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_BRCA_3DRNA, fig_Neu_BRCA_BPmetCan, fig_Neu_BRCA_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_BRCA_3DRNA, fig_Macro_BRCA_BPmetCan, fig_Macro_BRCA_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_BRCA <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_BRCA
ggsave("ALL_BRCA.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_BLCA_avrg <- cbind(lymph_BLCA_BPRNACan3DProMet_avr, HE_BLCA_modif$Lymphocytes)
colnames(Lym_BLCA_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_BLCA_BPRNACan3DProMet_avr - HE_BLCA_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_BLCA_avrg <- cbind(Macro_BLCA_BPRNACan3DProMet_avr, HE_BLCA_modif$Macrophages)
colnames(Macro_BLCA_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_BLCA_BPRNACan3DProMet_avr - HE_BLCA_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_BLCA_avrg <- cbind(rowMeans(cbind(BLCA_BPRNACan3DProMet_decon$Neu, BLCA_methy_decon$Neu)), HE_BLCA_modif$Neutrophils)
colnames(Neu_BLCA_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(BLCA_BPRNACan3DProMet_decon$Neu, BLCA_methy_decon$Neu) - HE_BLCA_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_BLCA_3DRNA, fig_Neu_BLCA_BPmetCan, fig_Neu_BLCA_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_BLCA_3DRNA, fig_Macro_BLCA_BPmetCan, fig_Macro_BLCA_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_BLCA <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_BLCA
ggsave("ALL_BLCA.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_UCEC_avrg <- cbind(lymph_UCEC_BPRNACan3DProMet_avr, HE_UCEC_modif$Lymphocytes)
colnames(Lym_UCEC_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_UCEC_BPRNACan3DProMet_avr - HE_UCEC_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_UCEC_avrg <- cbind(Macro_UCEC_BPRNACan3DProMet_avr, HE_UCEC_modif$Macrophages)
colnames(Macro_UCEC_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_UCEC_BPRNACan3DProMet_avr - HE_UCEC_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_UCEC_avrg <- cbind(rowMeans(cbind(UCEC_BPRNACan3DProMet_decon$Neu, UCEC_methy_decon$Neu)), HE_UCEC_modif$Neutrophils)
colnames(Neu_UCEC_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(UCEC_BPRNACan3DProMet_decon$Neu, UCEC_methy_decon$Neu) - HE_UCEC_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_UCEC_3DRNA, fig_Neu_UCEC_BPmetCan, fig_Neu_UCEC_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_UCEC_3DRNA, fig_Macro_UCEC_BPmetCan, fig_Macro_UCEC_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_UCEC <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_UCEC
ggsave("ALL_UCEC.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_CESC_avrg <- cbind(lymph_CESC_BPRNACan3DProMet_avr, HE_CESC_modif$Lymphocytes)
colnames(Lym_CESC_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_CESC_BPRNACan3DProMet_avr - HE_CESC_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_CESC_avrg <- cbind(Macro_CESC_BPRNACan3DProMet_avr, HE_CESC_modif$Macrophages)
colnames(Macro_CESC_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_CESC_BPRNACan3DProMet_avr - HE_CESC_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_CESC_avrg <- cbind(rowMeans(cbind(CESC_BPRNACan3DProMet_decon$Neu, CESC_methy_decon$Neu)), HE_CESC_modif$Neutrophils)
colnames(Neu_CESC_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(CESC_BPRNACan3DProMet_decon$Neu, CESC_methy_decon$Neu) - HE_CESC_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_CESC_3DRNA, fig_Neu_CESC_BPmetCan, fig_Neu_CESC_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_CESC_3DRNA, fig_Macro_CESC_BPmetCan, fig_Macro_CESC_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_CESC <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_CESC
ggsave("ALL_CESC.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
...
Lym_SKCM_avrg <- cbind(lymph_SKCM_BPRNACan3DProMet_avr, HE_SKCM_modif$Lymphocytes)
colnames(Lym_SKCM_avrg) <- c("Cancer_cell_fractions", "Lymphocytes")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((lymph_SKCM_BPRNACan3DProMet_avr - HE_SKCM_modif$Lymphocytes)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Macro_SKCM_avrg <- cbind(Macro_SKCM_BPRNACan3DProMet_avr, HE_SKCM_modif$Macrophages)
colnames(Macro_SKCM_avrg) <- c("Cancer_cell_fractions", "Macrophages")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean((Macro_SKCM_BPRNACan3DProMet_avr - HE_SKCM_modif$Macrophages)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
Neu_SKCM_avrg <- cbind(rowMeans(cbind(SKCM_BPRNACan3DProMet_decon$Neu, SKCM_methy_decon$Neu)), HE_SKCM_modif$Neutrophils)
colnames(Neu_SKCM_avrg) <- c("Cancer_cell_fractions", "Neutrophils")
grob <- grobTree(textGrob(paste("RMSE = ", round(sqrt(mean(rowMeans(cbind(SKCM_BPRNACan3DProMet_decon$Neu, SKCM_methy_decon$Neu) - HE_SKCM_modif$Neutrophils)^2, na.rm = T)), 2)), x=0.1,  y=0.8, hjust=0,
  gp=gpar(col="black", fontsize=15)))
...
neutro = ggarrange(fig_Neu_SKCM_3DRNA, fig_Neu_SKCM_BPmetCan, fig_Neu_SKCM_avrg, ncol = 3, nrow = 1, labels = "c", font.label = list(size = 20, color = "black"), align = "hv")
macro = ggarrange(fig_Macro_SKCM_3DRNA, fig_Macro_SKCM_BPmetCan, fig_Macro_SKCM_avrg, ncol = 3, nrow = 1, labels = "b", font.label = list(size = 20, color = "black"), align = "hv")


All_SKCM <- ggarrange(lymph, macro, neutro, ncol = 1, nrow = 3, font.label = list(size = 20, color = "black"), align = "hv")
...
All_SKCM
ggsave("ALL_SKCM.pdf", dpi = "print", width = 210, height = 297, units = "mm", scale = 2)
```
RNA, methylation, and averaged values of correlation across a : lymphocytes, b:  macrophages, c :  neutrophils, using the BPRNACan3D and BPMetCan signatures on EpiDish.
