...
for (i in 1:(ncol(data) - 1)) {
  cd4[[i]] <- local({
    ...
    x = ggplot(data, aes(x = data[, ncol(data)], y = data[, i])) +
      ...
      ylab("Deconv estimate") + xlab("FACS") + ggtitle(str_remove_all(names(data)[i], "(T_cell.)|(T.cell.)")) +
      ...
      annotate("text", x = -Inf, y = Inf, hjust=-0.5, vjust=1, label = paste("italic(r)==", round(cor.test(data[, i], data[, ncol(data)])$est, 2), "~','", "~italic(P)<", "2.2e-16"), parse = TRUE, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=-1, vjust=2, label = paste("RMSE =", round(sqrt(mean((data[, i] - data[, ncol(data)])^2, na.rm = T)), 2)), parse = F, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=2, vjust=3, label = paste("n = ", nrow(data)), size = 7)
  })
}
grid.arrange(grobs = cd4, ncol = 3, top = textGrob("CD4", gp=gpar(fontsize=20,font=3,face="bold")))
...
grid.arrange(grobs = cd8, ncol = 3, top = textGrob("CD8", gp=gpar(fontsize=20,font=3,face="bold")))
...
for (i in 1:(ncol(data) - 1)) {
  mono[[i]] <- local({
    ...
    x = ggplot(data, aes(x = data[, ncol(data)], y = data[, i])) +
      ...
      theme(axis.title.x= element_text(size = 12, face="bold"), 
          axis.title.y= element_text(size = 12, face="bold") )  + 
      ylab("Deconv estimate") + xlab("FACS") + ggtitle(names(data)[i]) +
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black"), plot.title = element_text(color = "black", size = 14, face = "bold.italic", hjust = 0.5, vjust = 1.5)) +
      annotate("text", x = -Inf, y = Inf, hjust=-0.5, vjust=1, label = paste("italic(r)==", round(cor.test(data[, i], data[, ncol(data)])$est, 2), "~','", "~italic(P)<", "2.2e-16"), parse = TRUE, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=-1, vjust=2, label = paste("RMSE =", round(sqrt(mean((data[, i] - data[, ncol(data)])^2, na.rm = T)), 2)), parse = F, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=2, vjust=3, label = paste("n = ", nrow(data)), size = 7)
...
grid.arrange(grobs = mono, ncol = 3, top = textGrob("Monocytes", gp=gpar(fontsize=20,font=3,face="bold")))
...
for (i in 1:(ncol(data) - 1)) {
  m1[[i]] <- local({
    ...
    x = ggplot(data, aes(x = data[, ncol(data)], y = data[, i])) +
      ...
      theme(axis.title.x= element_text(size = 12, face="bold"), 
          axis.title.y= element_text(size = 12, face="bold") )  + 
      ylab("Deconv estimate") + xlab("FACS") + ggtitle(str_remove_all(names(data)[i], "(Macrophage.)|(Macrophages.)")) +
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black"), plot.title = element_text(color = "black", size = 14, face = "bold.italic", hjust = 0.5, vjust = 1.5)) +
      annotate("text", x = -Inf, y = Inf, hjust=-0.5, vjust=1, label = paste("italic(r)==", round(cor.test(data[, i], data[, ncol(data)])$est, 2), "~','", "~italic(P)<", "2.2e-16"), parse = TRUE, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=-1, vjust=2, label = paste("RMSE =", round(sqrt(mean((data[, i] - data[, ncol(data)])^2, na.rm = T)), 2)), parse = F, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=2, vjust=3, label = paste("n = ", nrow(data)), size = 7)
...
grid.arrange(grobs = m1, ncol = 3, top = textGrob("Macrophages M1", gp=gpar(fontsize=20,font=3,face="bold")))
...
grid.arrange(grobs = m2, ncol = 3, top = textGrob("Macrophages M2", gp=gpar(fontsize=20,font=3,face="bold")))
...
for (i in 1:(ncol(data) - 1)) {
  b[[i]] <- local({
    ...
    x = ggplot(data, aes(x = data[, ncol(data)], y = data[, i])) +
      ...
      theme(axis.title.x= element_text(size = 12, face="bold"), 
          axis.title.y= element_text(size = 12, face="bold") )  + 
      ylab("Deconv estimate") + xlab("FACS") + ggtitle(str_remove_all(names(data)[i], ".cell.*")) +
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black"), plot.title = element_text(color = "black", size = 14, face = "bold.italic", hjust = 0.5, vjust = 1.5)) +
      annotate("text", x = -Inf, y = Inf, hjust=-0.5, vjust=1, label = paste("italic(r)==", round(cor.test(data[, i], data[, ncol(data)])$est, 2), "~','", "~italic(P)<", "2.2e-16"), parse = TRUE, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=-1, vjust=2, label = paste("RMSE =", round(sqrt(mean((data[, i] - data[, ncol(data)])^2, na.rm = T)), 2)), parse = F, size = 7) +
      annotate("text", x = -Inf, y = Inf, hjust=2, vjust=3, label = paste("n = ", nrow(data)), size = 7)
...
grid.arrange(grobs = b, ncol = 3, top = textGrob("B cells", gp=gpar(fontsize=20,font=3,face="bold")))
...
grid.arrange(grobs = nk, ncol = 3, top = textGrob("Natural Killers", gp=gpar(fontsize=20,font=3,face="bold")))
...
grid.arrange(grobs = neutro, ncol = 3, top = textGrob("Neutrophils", gp=gpar(fontsize=20,font=3,face="bold")))
```
...
grid.arrange(grobs = macro, ncol = 3, top = textGrob("Macrophages", gp=gpar(fontsize=20,font=3,face="bold")))
