...
dict_Vanderbilt[["CBSX_LM22"]] <- list(`B cells` = c("B.cells.memory", "B.cells.naive"),
                                      ...
                                      `Mural cells` = c(),
                                      NK = c("NK.cells.activated", "NK.cells.resting"), 
                                      `Plasma B cells` = c("Plasma.cells"),
                                      `T cells proliferative` = c(),
...
dict_Vanderbilt[["Quantiseq"]] <- list(CD4 = c("T.cell.CD4+.(non-regulatory)"), # "T.cell.regulatory(Tregs)"
                                   CD8 = c("T.cell.CD8+"),
                                   NK = c("NK.cell"))
