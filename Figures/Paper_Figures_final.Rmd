...
myeloma_all_signs["Mean", ] = colMeans(myeloma_all_signs, na.rm = T) %>% round(., 3)
myeloma_all_signs_p["Mean", ] = colMeans(myeloma_all_signs_p, na.rm = T)
```
...
Melanoma_GSE72056_all_signs["Mean", ] = colMeans(Melanoma_GSE72056_all_signs, na.rm = T) %>% round(., 3)
Melanoma_GSE72056_all_signs_p["Mean", ] = colMeans(Melanoma_GSE72056_all_signs_p, na.rm = T)
```
...
Melanoma_GSE93722_all_signs["Mean", ] = colMeans(Melanoma_GSE93722_all_signs, na.rm = T) %>% round(., 3)
Melanoma_GSE93722_all_signs_p["Mean", ] = colMeans(Melanoma_GSE93722_all_signs_p, na.rm = T)
```
