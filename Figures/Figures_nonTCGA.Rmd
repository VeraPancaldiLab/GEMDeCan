...
truth_Nakamura2018 <- as_tibble(FACS_Nakamura2018_mean, rownames = "Samples") %>%  mutate(Samples = as.numeric(Samples))
...
corr <- benchmark_corrplots(deconv_data = deconv_Nakamura2018, true_estimates = truth_Nakamura2018, dict = dict_Nakamura2018, key = "Samples", title = "test")
corr
```
