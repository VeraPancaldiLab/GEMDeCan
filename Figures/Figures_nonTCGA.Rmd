...
## Data loading
```{r}
deconv_GSE72056 <- read_tsv("/mnt/SERVER-CRCT-STORAGE/CRCT21/Private/Miguel/Projects/CRCT/21 - Epigenomics and network modelling of heterogeneity in immuno-oncology/Ting Xie/2021/CIBERSORTx/final_example_signatures/all_deconvolutions/all_deconvolutions_Melanoma_GSE72056_no_malighant.txt") %>% dplyr::rename_with(~str_replace(.,"__", "_CBSX_"))  %>% dplyr::rename_with(~str_replace(.,"__", "_")) #! fix naming of deconv results
...
# dict_GSE72056[["CCLE_TIL10"]] <- list(B = c(),
#                                      CAFs = c(),
#                                      CD4 = c(),
#                                      CD8 = c(),
#                                      Endothelial = c(),
...
```{r}
benchmark_corrplots(deconv_data = deconv_GSE72056, true_estimates = truth_GSE72056, dict = dict_GSE72056, key = "Samples", title = "GSE72056")
...
## Data loading
```{r}
deconv_Thomas <- read_tsv("/mnt/SERVER-CRCT-STORAGE/CRCT21/Private/Miguel/Projects/CRCT/21 - Epigenomics and network modelling of heterogeneity in immuno-oncology/Ting Xie/2021/CIBERSORTx/final_example_signatures/all_deconvolutions/all_deconvolutions_Thomas_RNAseq_part.txt") %>%
...
```{r}
benchmark_corrplots(deconv_data = deconv_Thomas, true_estimates = truth_Thomas, dict = dict_Thomas,  key = "Samples", title = "Thomas")
# corrplots$Macrophages <- corrplots$Macrophages + rremove("y.text")
# corrplots$Neutrophils <- corrplots$Neutrophils + rremove("y.text")
# summary_corrplot  <- ggarrange(plotlist = corrplots, ncol = 3, common.legend = T, widths = c(0.35, 0.35, 0.25) , legend = "bottom")
# 
